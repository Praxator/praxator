...
return [
    ...
    "in" => "Der ausgewählte Wert für das Feld :attribute ist ungültig.",
    ...
    "required" => "Das Feld :attribute field is required.",
    ...
    "unique" => "Der Wert des Feldes :attribute wurde schon verwendet.",
